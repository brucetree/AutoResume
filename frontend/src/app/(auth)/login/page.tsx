          ...
          <div className="w-full max-w-[420px] space-y-12">
            ...
            <div>
              <GoogleSignInButton
                ...
                className="w-full h-14 flex items-center justify-center gap-3 bg-surface-container-low border border-outline-variant/15 rounded-xl hover:bg-surface-container-high transition-colors active:scale-95 duration-200 disabled:opacity-50"
              >
