          ...
          <div className="lg:col-span-7">
            <div className="lg:bg-surface-container-lowest lg:p-10 xl:p-14 lg:rounded-xl lg:shadow-ambient-light lg:ghost-border">
              <form onSubmit={handleSubmit} className="space-y-6 lg:space-y-8">
                ...
                >
                  {loading ? 'Creating your account...' : 'Join AutoResume'}
                </button>
              </form>
              ...
              <div className="mb-12 lg:mb-0">
                <GoogleSignInButton
                  ...
                  className="w-full flex items-center justify-center gap-3 py-4 lg:py-3.5 px-4 bg-surface-container-low ghost-border rounded-lg hover:bg-surface-container-high active:scale-95 transition-all font-bold text-xs text-on-surface disabled:opacity-50"
                >
